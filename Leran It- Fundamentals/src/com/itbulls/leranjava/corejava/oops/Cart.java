package com.itbulls.leranjava.corejava.oops;
...
public class Cart {
	...
	private BigDecimal calculateTotalGrossPrice() {
		...
		this.toalTax =this.totalNetPrice.multiply(BigDecimal.valueOf(tax.getTaxRate()))
				.setScale(MONEY_SCALE, RoundingMode.HALF_UP);
		this.totalGrossPrice = this.totalNetPrice.add(this.toalTax).subtract(orderDiscount);
